...
export const SocialLinks: React.FC = () => {
  return (
    <div className="flex gap-3 text-theme-dark mt-2">
      {/* Github Icon */}
      ...
      <a href="#" className="hover:text-black transition-colors" aria-label="Twitter">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-12.7 12.5S.2 5.3 7.8 4.5c2.1-.1 3.2.4 3.2.4l2.5-3 1.5 1.3L22 4z"/></svg>
      </a>
      {/* Instagram Icon */}
      <a href="#" className="hover:text-black transition-colors" aria-label="Instagram">
       ...
       {/* RSS Icon */}
      <a href="#" className="hover:text-black transition-colors" aria-label="RSS">
